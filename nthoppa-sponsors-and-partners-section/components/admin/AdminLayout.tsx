...
const navigation = [
  ...
  { name: "Territories", href: "/admin/territories", icon: MapPin },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-4 bg-gradient-to-r from-purple-50 to-blue-50 border-b border-gray-200">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-purple-700">Admin Portal</span>
            </div>
          </div>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center gap-2 hover:bg-[#E9521C]/10">
                    ...
                    <span className="hidden md:inline font-medium">{adminName}</span>
                  </Button>
                </DropdownMenuTrigger>
